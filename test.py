...
parser.add_argument('--config', type=str, default='/home/huangwenmin/HiSD/configs/celeba-hq_256.yaml', help='Path to the config file.')
parser.add_argument('--checkpoint', type=str, default='/home/huangwenmin/HiSD/core/outputs/celeba-hq_256/checkpoints/gen_00600000.pt')
